...
df = pd.read_excel("overall_socialmorality_score.xlsx")
...
plt.tight_layout()
plt.suptitle("Overall Morality Score Over Time", fontsize=16, y=1.02)
plt.xlabel("Year")
plt.ylabel("Overall Morality Score (0-100)")
plt.show()
