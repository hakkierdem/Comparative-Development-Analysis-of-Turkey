...
df = pd.read_csv("overall_scientific_contribution_score.csv")
...
plt.tight_layout()
plt.suptitle("Overall Science Score Over Time", fontsize=16, y=1.02)
plt.xlabel("Year")
plt.ylabel("Overall Science Score (0-100)")
plt.show()
